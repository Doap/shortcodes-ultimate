...
//				$title = ( $atts['title'] === 'yes' && $slide['title'] ) ? '<div class="su-slider-slide-title">' .stripslashes( $slide['title'] ) . '</div>' : '';
 ...
 //$description = ( $atts['title'] === 'yes' && $slide['description'] ) ? '<div class="su-slider-slide-title slide-description" style="top:215px;font-size:10pt;">' . stripslashes( $slide['description'] ).  '</div>' : '';
...
//				echo PHP_EOL . $image . PHP_EOL;
				// Prepare slide title
				$title = ( $atts['title'] === 'yes' && $slide['title'] ) ? '<div class="nos_carousel_title">' . stripslashes( $slide['title'] ) . '</div>' : '';
				// Open slide
...
//				echo PHP_EOL . $image . PHP_EOL;
				// Prepare slide title
				$title = ( $atts['title'] === 'yes' && $slide['title'] ) ? '<div class="tcpf cat_carousel_title"><h4>' . stripslashes( $slide['title'] ) . '</h4></div>' : '';
				// Open slide
				//$return .= '<div class="su-carousel-slide" style="max-width:200px;padding:5px;"><div>';
				//$return .= '<div class="su-carousel-slide"><div>';
				$return .= '<div class="su-carousel-slide" style="width:' . $div_width . 'px;">';
...
//				echo PHP_EOL . $image . PHP_EOL;
				// Prepare slide title
				$title = ( $atts['title'] === 'yes' && $slide['title'] ) ? '<div class="lptv_carousel_title" style="background-color:#fff;line-height:1.1;font-size:.8em;font-weight:700;padding:2px 2px 2px 2px;text-align:center;">' . get_doap_limit_chars(stripslashes($slide['title']),41,1) . '</div>' : '';
				// Open slide
				//$return .= '<div class="su-carousel-slide" style="max-width:200px;padding:5px;"><div>';
				$return .= '<div class="su-carousel-slide">';
...
//				echo PHP_EOL . $image . PHP_EOL;
	...
	public static function posts( $atts = null, $content = null ) {
		...
		$args['date_query'] = array(array('column' => 'post_date', 'after' => '1 month ago'));
		// Ignore Sticky Posts
